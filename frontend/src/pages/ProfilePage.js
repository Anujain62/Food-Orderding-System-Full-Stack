 ...
 return (
  <PublicLayout>
   ...
   <div className='container py-5'>
    <h3 className='text-center text-primary mb-4'><i className='fas fa-user-circle me-1'></i>My Profile</h3>
    <form onSubmit={handleSubmit} className='card p-4 shadow-sm border-0'>
     <div className='row'>
      ...
      <div className='col-md-6 mb-3'>
       ...
       <input type='number' className='form-control' value={formData.mobile} disabled/>
      </div>
      <div className='col-md-6 mb-3'>
     ...
     <button type='submit' className='btn btn-primary mt-3'><i className='fas fa-save me-2'></i>Update Profile</button>
    </form>
   </div>
  </PublicLayout>
 )
