...
const AdminLogin = () => {
 ...
 const handleLogin = async (e) =>{
  ...
  return (
   ...
   style={{ backgroundImage: "url('/images/adminbg.png')", backgroundSize:"cover", backgroundPosition:"center" }}>
    <div className='card p-4 shadow-lg' style={{maxWidth:"400px", width:"100%"}}>
     ...
     <form onSubmit={handleLogin}>
      <div className='mb-3'>
       ...
       <input value={username} onChange={(e)=>setUsername(e.target.value)} type='text' className='form-control' placeholder='Enter admin username' required />
      </div>
      ...
      <button type='submit' className='btn btn-primary w-100 mt-3'> <FaSignInAlt className='me-1 icon-fix'/> Login</button>
     </form>
