...
function App() {
  return (
    ...
    <Routes>
      ...
      <Route path='/order-being-prepared' element={<FoodbeingPrepared />}></Route>
      <Route path='/order-pickup' element={<OrderPickup />}></Route>
      <Route path='/order-delivered' element={<FoodDelivered />}></Route>
      <Route path='/order-cancelled' element={<OrderCancelled />}></Route>
      <Route path='/all-order' element={<AllOrders />}></Route>
